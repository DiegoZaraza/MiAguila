# MiAguilaTest
Project designed for the automation of the website [ZAPATOCA](https://staging-zapatoca.miaguila.com/registro/?hidecaptcha=true)
...
Git:
    ...
    Whit SSH
    git clone git@github.com:DiegoZaraza/MiAguila.git
    cd KinCartaTest
    
    With HTTPS
    git clone https://github.com/DiegoZaraza/MiAguila.git
    cd KinCartaTest
    
Or simply [download a zip](https://github.com/DiegoZaraza/MiAguila/archive/refs/heads/main.zip) file
